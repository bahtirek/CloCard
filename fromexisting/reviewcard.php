	...
	<table align="center" style="width:310px; margin-bottom:7em; margin-top: 2em; background-color:#E4E4E4;border: 1px solid #9f9f9f; border-radius: 9px; box-shadow: 0 16px 18px 0 rgba(0, 0, 0, 0.2), 0 16px 30px 0 rgba(0, 0, 0, 0.19);">
		...
		<tr height="60px">
			<td style="text-align:center;">
				<a href="createnewcardfrommaster.php?cardreviewed=edit" title="Back"><img src="../images/back.png" width="50px" alt="Back"/></a>
			</td>
			<td style="text-align:center;">
				<a href="saveCardFromMaster.php" title="Save"><img src="../images/cloud.png" width="60px" alt="Save" /></a>
			</td>
